        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Cevirmen = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    YayinTarihi = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ListeFiyati = table.Column<double>(type: "float", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Yildiz = table.Column<byte>(type: "tinyint", nullable: true),
                    KitapId = table.Column<int>(type: "int", nullable: false),
                    YorumTipi = table.Column<byte>(type: "tinyint", nullable: false),
                    CreateDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    MyUserId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Kategoriler_MyUserId",
                table: "Kategoriler",
                column: "MyUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Kitaplar_MyUserId",
                table: "Kitaplar",
                column: "MyUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Yazarlar_Ad_Soyad",
                table: "Yazarlar",
                columns: new[] { "Ad", "Soyad" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Yazarlar_MyUserId",
                table: "Yazarlar",
                column: "MyUserId");
